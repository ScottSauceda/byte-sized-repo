...
import com.byte_sized.byte_sized.service.RoleService;
...
public class RoleController {
    ...
    public ResponseEntity<Optional<Role>> getRoleById(@PathVariable int roleId) throws RoleNotFoundException {
        try {
